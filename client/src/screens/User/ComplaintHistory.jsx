    ...
    <Layout userType="user">
      <div className="p-6 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Complaint History</h1>
            <p className="text-gray-300">View all your resolved and closed complaints</p>
          </div>
          <div className="text-right">
            <div className="text-2xl font-bold text-green-400">{complaints.length}</div>
            <div className="text-sm text-gray-400">Resolved Complaints</div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-700/50 border border-slate-600 rounded-md text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
              />
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <div className="text-gray-400">No resolved complaints found</div>
            <p className="text-gray-500 text-sm mt-2">No Complaints So Far !!!</p>
          </div>
        ) : (
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        complaint.status === 'resolved' ? 'bg-green-500 text-green-900' : 'bg-gray-500 text-gray-900'
                      }`}>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                        selectedComplaint.status === 'resolved' ? 'bg-green-500 text-green-900' : 'bg-gray-500 text-gray-900'
                      }`}>
              ...
              <div className="p-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white capitalize">{selectedComplaint.priority}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-400">Resolution Time</label>
                    <p className="text-white">{getResolutionTime(selectedComplaint.created_at, selectedComplaint.resolved_at)}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-green-900/20 border border-green-700/50 rounded-md p-3 mt-1">
                    <p className="text-green-300">{selectedComplaint.resolution || 'Resolution details not available'}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-slate-700">
                  ...
                  {selectedComplaint.resolved_at && (
                    <div>
                      <label className="text-sm font-medium text-gray-400">Resolved On</label>
